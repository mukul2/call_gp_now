...
class ChatScreen extends StatefulWidget {
  ...
  ChatScreen(this.partner_id, this.partner_name, this.partner_photo,
      this.own_id, this.own_name, this.own_photo, this.chatRoom,this.intentType);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(widget.partner_name,style: TextStyle(color: Colors.blue)),
        actions: <Widget>[
          Padding(
