...
class _MyHomePageState extends State<MyHomePage> with WidgetsBindingObserver {
  getVdoAppDataToday() async {
    ...
    String apiResponse =
        await makePostReq("get_video_appointment_today", AUTH_KEY, body);
    //showThisToast(apiResponse);
    this.setState(() {
      widget.todayList = json.decode(apiResponse);
      // showThisToast("this time video app size "+widget.pastList.length.toString());
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: ListTile(
                      onTap: () {
                        setState(() {
                          widget.urgentService = !(widget.urgentService);
                        });
                        DatabaseReference ref = FirebaseDatabase.instance
                            ...
                            .child("online_status")
                            .child("user_id" + UID);
                        ref.child("doc_name").set(UNAME);
                        ref.child("doc_id").set(UID);
                        ref.child("doc_photo").set(_baseUrl_image + UPHOTO);
                        ref.child("is_online").set(widget.urgentService);
                        ref
                            .child("last_online")
                            .set(new DateTime.now().toString());
                        ref.child("fees").set("Free");
                        ref.child("doc_dept").set(UDES);
                        // Navigator.push(
                        //     context,
                        //     MaterialPageRoute(
                      ...
                      trailing: Switch(
                        ...
                        value: widget.urgentService,
                      ),
                      leading: Icon(
                        Icons.calendar_today,
                        color: Colors.blue,
                      ),
                      title: Text("Urgent Care Available",
                  ...
                  child: Container(
                    ...
                    child: ListTile(
                      onTap: () {
                        ...
                        ref.child("doc_id").set(UID);
                        ref.child("doc_photo").set(_baseUrl_image + UPHOTO);
                        ref.child("is_online").set(widget.isOnline);
                        ref
                            .child("last_online")
                            .set(new DateTime.now().toString());
                        ref.child("fees").set("Free");
                      ...
                      leading: Icon(Icons.warning_rounded, color: Colors.blue),
                      title: Text(
                    ...
                    children: [
                      Padding(
                        ...
                        child: ListView.builder(
                          ...
                          shrinkWrap: true,
                          itemCount: widget.todayList == null
                              ? 0
                              : widget.todayList.length,
                          itemBuilder: (BuildContext context, int index) {
                            return new InkWell(
                              onTap: () {
                                widget.all_info = json.decode(
                                    widget.todayList[index]["all_info"]);

                                String chatRoom = createChatRoomName(
                                    int.parse(UID),
                                    widget.todayList[index]["patient_info"]
                                        ["id"]);
                                CHAT_ROOM = chatRoom;
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                            ...
                                            child: Padding(
                                              ...
                                              child: InkWell(
                                                onTap: () {
                                                  ...
                                                  CHAT_ROOM = chatRoom;
                                                //  showThisToast(chatRoom);
                                                 // showThisToast(widget.todayList[index]["patient_info"].toString());
                                                  Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                      ...
                                      ListTile(
                                        ...
                                        title: Text(widget.todayList[index]
                                            ["patient_info"]["name"]),
                                        subtitle: Text(
                                          "View Details",
                                          style: TextStyle(color: Colors.blue),
                      ...
                      StreamBuilder(
                          ...
                          builder: (context, snap) {
                            if (snap.hasData &&
                              ...
                              int i = 0;
                              widget.all_urgent_care_req.clear();
                              ...
                              values.forEach((key, value) {
                                if (value["status"] == "pending") {
                                  widget.all_urgent_care_req.add(value);
                                  print(widget.all_urgent_care_req.toString());
                                }
                              });
                              // widget.myPotition = widget.downloadedData.length + 1;
                            }
                            widget.all_urgent_care_req =
                                widget.all_urgent_care_req.reversed.toList();
                            ...
                            return Padding(
                              ...
                              child: ListView.builder(
                                reverse: false,
                                shrinkWrap: true,
                                itemCount: widget.all_urgent_care_req == null
                                    ? 0
                                    : widget.all_urgent_care_req.length,
                                itemBuilder: (BuildContext context, int index) {
                                  return new Padding(
                                    padding: EdgeInsets.fromLTRB(15, 0, 15, 5),
                                    child: Container(
                                      child: ListTile(
                                        //leading: CircleAvatar(backgroundImage: NetworkImage(_baseUrl_image+ widget.all_urgent_care_req[index]["patient_photo"]),),
                                        leading: Checkbox(
                                          onChanged: (value) {
                                          ...
                                          value:
                                              widget.all_urgent_care_req[index]
                                                  ["isServed"],
                                        ),
                                        title: Text(
                                            widget.all_urgent_care_req[index]
...
class AppointmentPastNew extends StatefulWidget {
  List pastList = [];
  List upCommingList = [];
  dynamic all_info;

  @override
  _AppointmentPastNewState createState() => _AppointmentPastNewState();
}

class _AppointmentPastNewState extends State<AppointmentPastNew> {
  getVdoAppDataPast() async {
    body = <String, String>{'user_type': "doctor", 'id': UID};
    String apiResponse =
        await makePostReq("get_video_appointment_past", AUTH_KEY, body);
    // showThisToast(apiResponse);
    this.setState(() {
        ...
        body: TabBarView(
          children: [
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return new InkWell(
                    onTap: () {
                      widget.all_info =
                          json.decode(widget.upCommingList[index]["all_info"]);

                      String chatRoom = createChatRoomName(int.parse(UID),
                          widget.upCommingList[index]["patient_info"]["id"]);
                      CHAT_ROOM = chatRoom;
                     // showThisToast(chatRoom);
                      // showThisToast(_baseUrl_image+data[index]["dr_info"]["photo"]);
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) => Scaffold(
                                    appBar: AppBar(
                                      iconTheme:
                                          new IconThemeData(color: Colors.blue),
                                      title: Text(
                                        "Appointment Details",
                                        style: TextStyle(color: Colors.blue),
                                      ),
                        ...
                        child: Column(
                          ...
                          children: [
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(widget.upCommingList[index]
                                            ["date"] +
                                        " " +
                                        widget.upCommingList[index]["time"]),
                                  ),
                                ),
                                Align(
                                  alignment: Alignment.centerRight,
                            ...
                            ListTile(
                              ...
                              title: Text(widget.upCommingList[index]
                                  ["patient_info"]["name"]),
                              subtitle: Text(
                                "View Details",
                                style: TextStyle(color: Colors.blue),
            ...
            Padding(
              ...
              child: ListView.builder(
                shrinkWrap: true,
                itemCount: widget.pastList == null ? 0 : widget.pastList.length,
                itemBuilder: (BuildContext context, int index) {
                  return new InkWell(
                    onTap: () {
                      widget.all_info =
                      ...
                      String chatRoom = createChatRoomName(int.parse(UID),
                          widget.pastList[index]["patient_info"]["id"]);
                      CHAT_ROOM = chatRoom;
                   //   showThisToast(chatRoom);
                      // showThisToast(_baseUrl_image+data[index]["dr_info"]["photo"]);
                      Navigator.push(
                            ...
                            Stack(
                              children: [
                                Align(
                                  ...
                                  child: Padding(
                                    padding: EdgeInsets.all(15),
                                    child: Text(widget.pastList[index]["date"] +
                                        " " +
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    padding: EdgeInsets.all(15),
                                    child: Text(
                                        widget.pastList[index]["status"] == 1
                                            ? "Compleated"
                                            : "Pending"),
                                  ),
                                ),
                            ...
                            ListTile(
                              leading: CircleAvatar(
                                backgroundImage: NetworkImage(_baseUrl_image +
                                        ...
                                        null
                                    ? ""
                                    : widget.pastList[index]["patient_info"]
                                        ["photo"]),
                              ),
                              title: Text(widget.pastList[index]["patient_info"]
                                  ["name"]),
                              subtitle: Text(
                                "Send a Message",
                                style: TextStyle(color: Colors.blue),
...
class AppointmentToday extends StatefulWidget {
  List pastList = [];
  List todayList = [];
  dynamic all_info;

  @override
  _AppointmentTodayState createState() => _AppointmentTodayState();
}

class _AppointmentTodayState extends State<AppointmentToday> {
  getVdoAppDataToday() async {
    body = <String, String>{'user_type': "doctor", 'id': UID};
    String apiResponse =
        await makePostReq("get_video_appointment_today", AUTH_KEY, body);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: ListView.builder(
        scrollDirection: Axis.horizontal,
        shrinkWrap: true,
        itemCount: widget.todayList == null ? 0 : widget.todayList.length,
        itemBuilder: (BuildContext context, int index) {
          return new InkWell(
            onTap: () {
              widget.all_info =
                  json.decode(widget.todayList[index]["all_info"]);

              String chatRoom = createChatRoomName(
                  int.parse(UID), widget.todayList[index]["dr_info"]["id"]);
              CHAT_ROOM = chatRoom;
            //  showThisToast(chatRoom);
              // showThisToast(_baseUrl_image+data[index]["dr_info"]["photo"]);
              Navigator.push(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Expanded(
                                                  child: ListTile(
                                                title: Text("Age and gender"),
                                                subtitle: Text(widget
                                                        .all_info["age"]
                                                        .toString() +
                                                    " , " +
                                                    widget.all_info["gender"]),
                                              )),
                                            ],
                                          ),
                                          Divider(
                                          ...
                                          Row(
                                            children: [
                                              Expanded(
                                                ...
                                                title: Text("Weight"),
                                                subtitle: Text(
                                                    widget.all_info["weight"]),
                                              )),
                                              Expanded(
                                                  child: ListTile(
                                                title: Text("Temparature"),
                                                subtitle: Text(widget
                                                    .all_info["temparature"]),
                                              )),
                                            ],
                                          ),
                                          Divider(
                ...
                child: Column(
                  ...
                  children: [
                    Stack(
                      children: [
                        Align(
                          ...
                          child: Padding(
                            padding: EdgeInsets.all(15),
                            child: Text(widget.todayList[index]["date"] +
                                " " +
                                widget.todayList[index]["time"]),
                          ),
                        ),
                        Align(
                          alignment: Alignment.centerRight,
                          child: Padding(
                            padding: EdgeInsets.all(15),
                            child: Text(widget.todayList[index]["status"] == 1
                                ? "Compleated"
                                : "Pending"),
                          ),
                        ),
                    ...
                    ListTile(
                      leading: CircleAvatar(
                        backgroundImage: NetworkImage(_baseUrl_image +
                                    widget.todayList[index]["dr_info"]
                                        ["photo"] ==
                                null
                            ? ""
                            : widget.todayList[index]["dr_info"]["photo"]),
                      ),
                      title: Text(widget.todayList[index]["dr_info"]["name"]),
                      subtitle: Text(
                        "View Details",
                        style: TextStyle(color: Colors.blue),
                      ),
                      trailing: InkWell(
                        onTap: () {
                          String chatRoom = createChatRoomName(int.parse(UID),
                              widget.todayList[index]["dr_info"]["id"]);
                          CHAT_ROOM = chatRoom;
                          //showThisToast(chatRoom);
                          // showThisToast(_baseUrl_image+data[index]["dr_info"]["photo"]);
                          Navigator.push(
...
class ServiceFeesActivity extends StatefulWidget {
  List serviceFeesList = [];

  @override
  _ServiceFeesActivityState createState() => _ServiceFeesActivityState();
}

class _ServiceFeesActivityState extends State<ServiceFeesActivity> {
  Future<String> getData() async {
    //showThisToast("going to trigger");

    final http.Response response =
        await http.post(_baseUrl + 'get_service_fees_',
            headers: <String, String>{
              'Content-Type': 'application/json; charset=UTF-8',
              'Authorization': AUTH_KEY,
            },
            body: jsonEncode(<String, String>{'id': UID}));

    print(response.body.toString());
    showThisToast(response.statusCode.toString());
    setState(() {
      widget.serviceFeesList = json.decode(response.body);
    });
    return "Success!";
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: ListView.builder(
          shrinkWrap: true,
          itemCount: widget.serviceFeesList == null
              ? 0
              : widget.serviceFeesList.length,
          itemBuilder: (BuildContext context, int index) {
            return Card(
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(00.0),
              ...
              child: Column(
                children: <Widget>[
                  ListTile(
                          ...
                          return AlertDialog(
                                ...
                                children: <Widget>[
                                  Form(
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        TextFormField(
                                          initialValue: widget.serviceFeesList[index]["fees"].toString(),
                                          validator: (value) {
                                            newFees = value;
                                            if (value.isEmpty) {
                            ...
                            actions: <Widget>[
                              ...
                              FlatButton(
                                ...
                                onPressed: () async{
                                  if (_formKey.currentState.validate()) {
                                    int status =await updateBasicServiceFees(
                                        AUTH_KEY, UID, (index+1).toString(),newFees);


                                    Function myFun (){
                                      setState(() {
                                        widget.serviceFeesList[index]["fees"]= newFees;
                                        Navigator.of(context).pop();
                                      });
                                    }
                                    //Navigator.of(context).pop()
                    ...
                    trailing: new Text(
                      widget.serviceFeesList[index]["fees"].toString(),
                      style: TextStyle(fontWeight: FontWeight.bold),
                    ),
                    title: new Text(
                      widget.serviceFeesList[index]["name"],
                      style: TextStyle(fontWeight: FontWeight.bold),
                    ),
                  ),
                ],
      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text("Title"),
              Text(ambulanceBody["Title"],
                  style: TextStyle(color: Colors.blue)),
              Text("phone"),
              Text(ambulanceBody["phone"],
                  style: TextStyle(color: Colors.blue)),
              Text("area"),
              Text(ambulanceBody["area"], style: TextStyle(color: Colors.blue)),
              Text("address"),
              Text(ambulanceBody["address"],
                  style: TextStyle(color: Colors.blue)),
              Text("District"),
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          MyChamberOpeningTimesActivity(AUTH_KEY, UID)));
            },
            trailing: Icon(Icons.keyboard_arrow_right),
            title: Text("Chamber"),
            subtitle: Text("Edit/View your chamber Schedule"),
            leading: Icon(Icons.supervised_user_circle),
          ),
        ],
      ),
...
class AppointmentPagerDoctor extends StatefulWidget {
  @override
  _AppointmentPagerDoctorState createState() => _AppointmentPagerDoctorState();
}

class _AppointmentPagerDoctorState extends State<AppointmentPagerDoctor> {
  @override
  Widget build(BuildContext context) {
    return Container(
        child: DefaultTabController(
                      ...
                      return AlertDialog(
                        ...
                        actions: <Widget>[
                          ...
                          FlatButton(
                            ...
                            onPressed: () {
                              if (_formKey.currentState.validate()) {
                                var status = updateDesignationName(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              PrescriptionWriteWidgetForReview(
                                  widget.prescriptionBody)));
                },
                child: Card(
                  color: Colors.blue,
                  child: Center(
