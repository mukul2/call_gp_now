...
import 'package:call_gp_now/view/doctor/Widgets.dart';
import 'package:call_gp_now/view/login_view.dart';
import 'package:call_gp_now/view/patient/OnlineDoctorFullProfileView.dart';
import 'package:call_gp_now/view/patient/screens/DoctorLogin/bloc.dart';
              ...
              child: RaisedButton(
                ...
                onPressed: () async {
                  ...
                  if (_formKey.currentState.validate()) {
                    Block.getInstance().clickedLogin(context,email,password,userType);
