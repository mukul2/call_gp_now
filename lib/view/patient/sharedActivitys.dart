  ...
  Widget build(BuildContext context) {
    return widget.videoAppList.length > 0
        ? ListView.builder(
            shrinkWrap: true,
            itemCount:
                widget.videoAppList == null ? 0 : widget.videoAppList.length,
                ...
                child: Card(
                  ...
                  child: Padding(
                    ...
                    child: ListTile(
                      ...
                      title:
                          Text(widget.videoAppList[index]["dr_info"]["name"]),
                      subtitle: Text(
                        "Send a Message",
...
class FollowupVideoAppointmentListActivityPatient extends StatefulWidget {
  ...
  FollowupVideoAppointmentListActivityPatient(
      this.AUTH, this.USER_ID, this.USER_PHOTO);
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) => ChatScreen(
                                ...
                                widget.USER_ID,
                                UNAME,
                                _baseUrl_image + widget.USER_PHOTO,
                                chatRoom,
                                "scheduled")));
                  },
                  child: Card(
...
class ChoosePrescriptionForPrescriptionreview extends StatefulWidget {
  ...
  ChoosePrescriptionForPrescriptionreview(this.AUTH, this.USER_ID, this.DR_ID,
      this.TRANS_ID, this.PAYPAL_ID, this.ISPAYLATER, this.ISPAID);
                  ...
                  child: Card(
                    ...
                    child: Padding(
                      ...
                      child: ListTile(
                        leading: CircleAvatar(
                          backgroundImage: NetworkImage(_baseUrl_image +
                              widget.data[index]["dr_info"]["photo"]),
                        ),
...
class MyChamberOpeningTimesActivity extends StatefulWidget {
  String AUTH, USER_ID;
  List data = [];

  MyChamberOpeningTimesActivity(this.AUTH, this.USER_ID);

  @override
  _MyChamberOpeningTimesActivityState createState() =>
      _MyChamberOpeningTimesActivityState();
}

class _MyChamberOpeningTimesActivityState
    extends State<MyChamberOpeningTimesActivity> {
  String user_name_from_state = UNAME;
  String user_picture = UPHOTO;
  ...
  Future getData() async {
    body = <String, String>{'id': widget.USER_ID};
    String apiResponse =
        await makePostReq("get_video_call_available_time", widget.AUTH, body);
    this.setState(() {
      respo = json.decode(apiResponse);
      widget.data = respo;
      //showThisToast("skill row found "+data.length.toString());
  ...
  Future updateChamberInfo() async {
    //showThisToast(widget.data.toString());
    //print(jsonDecode(widget.data.toString()));
    var body_ = jsonEncode(<String, String>{
      'dr_id': widget.USER_ID,

      'days': json.encode(widget.data)
    });
    final http.Response response = await http.post(
      _baseUrl + 'chamber_days_update',
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
                      ...
                      child:Column(
                        children: [
                          Row(
                            children: [
                              Checkbox(
                                value: widget.data[index]["status"] == "1"
                                    ? true
                                    : false,
                              ),
                              Text(getDayName(int.parse(widget.data[index]["day"]))),
                            ],
                                ...
                                children: [
                                  Expanded(
                                    child: Column(
                                      children: [
                                        Text(
                                            "Morning",textAlign: TextAlign.start,style: TextStyle(color: Colors.blue), ),
                                        InkWell(
                                          onTap: () {
                                            String hour = "00";
                                            String minute = "00";
                                                              ...
                                                              SizedBox(
                                                                ...
                                                                child: InkWell(
                                                                  onTap: () {
                                                                    ...
                                                                    setState(() {
                                                                      widget.data[index]["morning"]["starts"] =  hour+":"+minute;

                                                                    });
                                                                    this.updateChamberInfo();
                                          ...
                                          child: Text("Opens : " + widget.data[index]["morning"]["starts"]),
                                        ),
                                        InkWell(
                                          onTap: () {
                                            String hour = "00";
                                                              ...
                                                              SizedBox(
                                                                ...
                                                                child: InkWell(
                                                                  onTap: () {
                                                                    ...
                                                                    setState(() {
                                                                      widget.data[index]["morning"]["ends"] = hour+":"+minute;
                                          ...
                                          child: Text(
                                            "Closes " + widget.data[index]["morning"]["ends"],textAlign: TextAlign.start,)
                                        ),
                                  ...
                                  Expanded(
                                    child: Column(
                                      children: [
                                        Text(
                                            "Afternoon" ,textAlign: TextAlign.start,style: TextStyle(color: Colors.blue)),
                                        InkWell(
                                          onTap: () {
                                            String hour = "00";
                                            String minute = "00";
                                                              ...
                                                              SizedBox(
                                                                ...
                                                                child: InkWell(
                                                                  onTap: () {
                                                                    ...
                                                                    setState(() {
                                                                      widget.data[index]["afternoon"]["starts"] = hour+":"+minute;
                                          ...
                                          child: Text("Opens : " + widget.data[index]["afternoon"]["starts"]),
                                        ),
                                        InkWell(
                                            onTap: () {
                                              String hour = "00";
                                                                ...
                                                                SizedBox(
                                                                  ...
                                                                  child: InkWell(
                                                                    onTap: () {
                                                                      ...
                                                                      setState(() {
                                                                        widget.data[index]["afternoon"]["ends"] = hour+":"+minute;
                                            ...
                                            child: Text(
                                              "Closes " + widget.data[index]["afternoon"]["ends"],textAlign: TextAlign.start,)
                                        ),
                                      ],
                                    ),
                                  ),
                                  Expanded(
                                    child: Column(
                                      children: [
                                        Text(
                                            "Evening" ,textAlign: TextAlign.start,style: TextStyle(color: Colors.blue)),
                                        InkWell(
                                          onTap: () {
                                            String hour = "00";
                                            String minute = "00";
                                                              ...
                                                              SizedBox(
                                                                ...
                                                                child: InkWell(
                                                                  onTap: () {
                                                                    ...
                                                                    setState(() {
                                                                      widget.data[index]["evening"]["starts"] = hour+":"+minute;
                                          ...
                                          child: Text("Opens : " + widget.data[index]["evening"]["starts"]),
                                        ),
                                        InkWell(
                                            onTap: () {
                                              String hour = "00";
                                                                ...
                                                                SizedBox(
                                                                  ...
                                                                  child: InkWell(
                                                                    onTap: () {
                                                                      ...
                                                                      setState(() {
                                                                        widget.data[index]["evening"]["ends"] = hour+":"+minute;
                                            ...
                                            child: Text(
                                              "Closes " + widget.data[index]["evening"]["ends"],textAlign: TextAlign.start,)
                                        ),
                                      ],
                                    ),
                                  ),
